...
public class UnknownClipObject : ClipObject, IUnknownMetasiaObject
{
    ...
    public string RawXml
    {
        get
        {
            ...
            var root = document.CreateElement(nameof(ClipObject));
            ...
            AppendElement(document, root, nameof(StartFrame), StartFrame.ToString());
            AppendElement(document, root, nameof(EndFrame), EndFrame.ToString());
