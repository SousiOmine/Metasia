...
public class ProjectState : IProjectState
{
    ...
    public async Task LoadProjectAsync(MetasiaEditorProject project)
    {
        ...
        _currentProjectInfo = new ProjectInfo(project.ProjectFile.Framerate, new SKSize(project.ProjectFile.Resolution.Width, project.ProjectFile.Resolution.Height), 44100);
